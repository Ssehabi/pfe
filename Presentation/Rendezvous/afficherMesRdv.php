                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!--    <a data-bs-toggle="modal" class="btn-cr" data-bs-target="#status $t->get("i") ?>"> -->
                                                     ...
                                                     <!-- --------------------Modifier------------------- -->
                                                    <div class="modal fade bd-example-modal-xl" id="modifier<?=  $t['idRdv']//$t->get("i") ?>" tabindex="0" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                                        ...
                                                                        <div class="form-body">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    ...
                                                                                    <textarea name="motifStatus" class="form-control" rows="5" cols="35" hidden><?= $t['MotifStatus']//$t->get("s") ?></textarea><br>
                                                                                        ...
                                                                                        <select name="consultationId" type="text" value="" class=" form-select" style="width: 15rem;height:2rem; background-color: var(--bs-body-bg);">
                                                                                          ...
                                                                                          <?php
                                                                                           // require "../../Metier/typeconsultation.php";idConsultation
                                                                                            ...
                                                                                            foreach($tab3 as $t3) {
                                                                                                if ($t['idConsultation']==$t3->get("i")) { echo "<option value='".$t3->get("i")."' selected >".$t3->get("t")."</option>"; }
                                                    ...
                                                    <!-- ------------------ consulter decision------------------- -->
                                                    <div class="modal fade bd-example-modal-xl" id="consulter<?=  $t['idRdv']//$t->get("i") ?>" tabindex="0" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-md">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                                ...
                                                                                <div class="col-12">
                                                                                   <!-- <input type="hidden" name="id" value=>> --->
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea name="motifStatus" class="form-control" rows="5" cols="35" readonly><?= $t['MotifStatus']//$t->get("m") ?></textarea><br>
